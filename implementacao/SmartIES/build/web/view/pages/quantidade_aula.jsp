...
<html>
    <head>
        ...
        <title>Quanitidade de aulas (tendência)</title>
        ...
        <script src="view/resources/javascript/linechart.js"></script>
    ...
    <body onLoad="plotaGraficos('view/resources/jsons/data_line.tsv');">
        <c:import url="/view/includes/menu.jsp"></c:import>
        <div class="container">      	
            <h2 class="page-header"><i class="fa fa-line-chart"></i> Quantidade de aulas (tendências)</h2>
            <button onClick="plotaGraficos('view/resources/jsons/data_line.tsv');" class="botao">Desenhar +1</button>
            <div id="linechart" class="caixa"></div>
